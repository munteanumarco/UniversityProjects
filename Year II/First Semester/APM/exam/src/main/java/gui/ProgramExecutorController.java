...
public class ProgramExecutorController {
    ...
    public void initialize() {
        ...
        //initialize the two columns of the lockTable
    ...
    //function to populate the lockTable
        ...
        if (controller != null) {
            try {
                ...
                if (programStates.size() > 0) {
                    ...
                    alert.setContentText("There is no instruction to execute!");
                    alert.showAndWait();
                }
            } catch (InterpreterException | InterruptedException e) {
                Alert alert = new Alert(Alert.AlertType.ERROR);
                alert.setTitle("Execution error!");
                alert.setHeaderText("An execution error occurred!");
